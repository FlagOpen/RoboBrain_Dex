...
@dataclass
class Phi_7B_DINOSigLIP_224px(Exp_7B_One_Stage):
    model_id: str = "phi-dinosiglip-224px+3b"
    vision_backbone_id: str = "dinosiglip-vit-so-224px"
    image_resize_strategy: str = "resize-naive"
    llm_backbone_id: str = "phi-2+3b"
    arch_specifier: str = "no-align+fused-gelu-mlp"
...
@dataclass
class Exp_3B_Robobrain_Dex(ModelConfig):
    model_id: str = "qwen2.5+3b"
    arch_specifier: str = "DummyProjector"

    vision_backbone_id: str = "qwen-vision-backbone"
    llm_backbone_id: str = "qwen-llm-backbone"
...
class ModelRegistry(Enum):
    ...
    Robobrain_Dex_3B= Exp_3B_Robobrain_Dex
