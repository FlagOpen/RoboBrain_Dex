...
class WeightsBiasesTracker:
    ...
    def initialize(self) -> None:
        print(f"Initializing W&B with run_id: {self.run_id}, wandb_dir: {self.wandb_dir}, project: {self.project}, entity: {self.entity}, group: {self.group}")
        wandb.init(
            name=self.run_id,
            dir=self.wandb_dir,
            config=self.hparams,
...
class Metrics:
    def __init__(
        ...
        hparams: Dict[str, Any],
        stage: str,
        wandb_project: str = "robobrain-dex",
